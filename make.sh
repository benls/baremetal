...
$CC $gcc_flags -T start.ld -Wl,-Map=output.map -o start.elf start.o main.o uart.o task_switch.o task.o file.o sbrk.o debug.o timer.o vector-table.o interrupt.o
